...
public class Main1722 {
    ...
    public static void main(String[] args) throws IOException{
        ...
        // N=4 일 때, 경우의 수들을 적어 놓고 잘 관찰해보면 맨 앞자리 숫자에 따라 각각 6개의
        ...
        // ex) N = 4, Q = 1, K = 3
        if(Q == 1){
            long K = Long.parseLong(token.nextToken()); // K 입력
            ...
            for(int i = 1; i <= N; i++){    // i=1
                ...
                // 만약, S[1]=1(순열의 첫 번째 숫자=1)로 확정된 상태에서 cnt=2라면,
                // 이는 확정되지 않은 순열의 (2,3,4)번째 숫자 중 2번째인 3을 뜻한다.
            ...
            // S[2] = 3 => i=2, j=3, cnt=2, K=1 => i=2번째 자리에는 확정되지 않은 수 중 cnt=2번째 숫자인 j=3이다.
            // S[3] = 2 => i=3,
            // S[4] = 4 => i=4,
            for(int i = 1; i <= N; i++){
                bw.write(S[i] + " ");
